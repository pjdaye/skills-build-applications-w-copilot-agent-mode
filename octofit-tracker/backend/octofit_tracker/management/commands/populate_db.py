...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        activities = [
            ...
            Activity(_id=ObjectId(), user=users[1], activity_type='Crossfit', duration=120, date="2025-04-08"),
            Activity(_id=ObjectId(), user=users[2], activity_type='Running', duration=90, date="2025-04-08"),
            Activity(_id=ObjectId(), user=users[3], activity_type='Strength', duration=30, date="2025-04-08"),
            Activity(_id=ObjectId(), user=users[4], activity_type='Swimming', duration=75, date="2025-04-08"),
        ]
